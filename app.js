document.addEventListener('DOMContentLoaded', () => {
    ...
    for (let i=0; i<squares.length; i++){
        //for each square on the board run this function:
    (function(i){
...
//the above code runs every time someone places a square - it checks every winning combo with the four squares and checks them against whether or not any of the 
// winning combos have player-one or player two classnames.
